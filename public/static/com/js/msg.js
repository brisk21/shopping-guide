...
var msg = {
    ...
    success: function (text, func) {
        this.show(text, '<svg style="width: 3rem !important;padding: 1.5rem !important; padding-bottom: 1.1rem !important; box-sizing: content-box;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2351"><path d="M384 887.456L25.6 529.056 145.056 409.6 384 648.544 878.944 153.6 998.4 273.056z" p-id="2352" fill="#ffffff"></path></svg>');
